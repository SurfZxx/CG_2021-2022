...
class fireObject(Base):
    def initialize():
        ...
        fire_textmaterial = TextureMaterial(texture=fire_texttexture)

        mesh = Mesh(fire_element, fire_material)
        mesh1 = Mesh(fire_text_box, fire_textmaterial)
