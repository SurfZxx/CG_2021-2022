...
class CuboidGeometry(Geometry):
    def __init__(self, width=1, height=1, depth=1):
        super().__init__()
        # vertices
        p0 = [-width / 2, -height, -depth / 2]
        p1 = [width / 2, -height, -depth / 2]
        p2 = [-width / 2, height, -depth / 2]
        p3 = [width / 2, height, -depth / 2]
        p4 = [-width / 2, -height, depth / 2]
        p5 = [width / 2, -height, depth / 2]
        p6 = [-width / 2, height, depth / 2]
        p7 = [width / 2, height, depth / 2]
